...
class GoogleAuthRepositoryImpl(
    ...
    override fun isConnected(): Boolean = kotlinx.coroutines.runBlocking {
    ...
    // Returns the authorization result — caller must check hasResolution()
    ...
    // Call this after the user completes the consent screen.
    ...
    // Call after a silent requestAuthorization() succeeds (no resolution needed).
